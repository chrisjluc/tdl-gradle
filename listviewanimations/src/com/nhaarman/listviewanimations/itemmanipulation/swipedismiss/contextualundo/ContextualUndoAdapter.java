 ...
 * <p>
 * Usage: <br>
 * * Create a new instance of this class providing the {@link BaseAdapter} to wrap, the undo layout, the undo button id and a {@link com.nhaarman.listviewanimations.itemmanipulation.swipedismiss.contextualundo.ContextualUndoAdapter.DeleteItemCallback}, optionally a delay time millis,
...
public class ContextualUndoAdapter extends BaseAdapterDecorator implements ContextualUndoListViewTouchListener.Callback {
     ...
     * @param deleteItemCallback The {@link com.nhaarman.listviewanimations.itemmanipulation.swipedismiss.contextualundo.ContextualUndoAdapter.DeleteItemCallback} which is called when an item should be deleted from your collection.
     * @param countDownFormatter The {@link com.nhaarman.listviewanimations.itemmanipulation.swipedismiss.contextualundo.ContextualUndoAdapter.CountDownFormatter} which provides text to be shown in the {@link TextView} as specified by countDownTextViewResId
     */
    ...
    private void deleteItemGivenId(final long deleteItemId) {
        ...
        if (position >= 0) {
            mDeleteItemCallback.deleteItem(position, mCurrentRemovedView);
        }
    }
    ...
    private class RemoveViewAnimatorListenerAdapter extends AnimatorListenerAdapter {
        ...
        private void deleteCurrentItem(final View view) {
            ...
            mDeleteItemCallback.deleteItem(position, view);
        }
